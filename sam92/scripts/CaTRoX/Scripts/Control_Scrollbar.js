// ====================================== //
// @name "Scrollbar Control (22.10.2013)"
...
(function createScrollbarImages() {
    ...
    scrollColorNormal = RGB(130, 132, 134),
    scrollColorHover = RGB(140, 142, 144),
    scrollColorHot = RGB(170, 172, 174),
    scrollColorPressed = RGB(90, 92, 94),
    ...
    scrollTrackColor = RGB(37, 37, 37); // must be without alpha channel when cleartype font is used
