...
function on_notify_data(wshColorScheme, info) {
...
sliderBackColor = blendColors(negative(posColor ),-2039584,.8 );
    }
...
function on_paint(gr) {
    ...
    var x = seekbarX,
        ...
        sliderTextColor = (fb.IsPlaying ? RGB(255, 255, 255) : RGB(80, 80, 80));
    ...
    gr.FillSolidRect(x-1, y + p-1, w+2, h - p * 2+2 ,sliderBackColor);
...
function createButtonImages() {
    ...
    for (var i in btn) {
        ...
        for (var s = 0; s <= 2; s++) {
            ...
            //---> 
            g.FillSolidRect(0, 0, w, h,posColor);
