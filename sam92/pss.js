...
$showpanel_c(MR0,$ifequal($strcmp(%MIDRIGHT%,MR0),1,1,0))
  $showpanel_c(MR1,$ifequal($strcmp(%MIDRIGHT%,MR1),1,1,0))
...
$font(FontAwesome,12,)
$puts(t5,[$char(61483) $meta(genre,0)])
$puts(w5,$gettextwidth($get(t5)))
...
$puts(yoffset,0)
$font(Source Han Sans Medium,12,)
$textbutton($get(xoffset),$get(yoffset),$add($get(w1),10),%topBarH%,$get(t1),$get(t1),SETGLOBAL:MIDRIGHT:MR0;SETGLOBAL:MID:M;SETGLOBAL:RIGHT:R;SETGLOBAL:bTog:0;SETGLOBAL:BOT:B2;SETGLOBAL:LEFT:L11;REFRESH,fontcolor:%colorSchemeLight%,brushcolor:%colorSchemeDark%-00)
$puts(yoffset,1)
$font(FontAwesome,12,)
$puts(xoffset,$add($get(xoffset),$add($get(w1),10)))
$textbutton($get(xoffset),$get(yoffset),$add($get(w2),10),%topBarH%,$get(t2),$get(t2),SETGLOBAL:MIDRIGHT:MR;SETGLOBAL:MID:M1;SETGLOBAL:RIGHT:R0;SETGLOBAL:bTog:0;SETGLOBAL:BOT:B2;SETGLOBAL:LEFT:L8;REFRESH,fontcolor:%colorSchemeLight%,brushcolor:40-40-40-00)

$font(FontAwesome,12,)
$puts(xoffset,$add($get(xoffset),$add($get(w2),10)))
$textbutton($get(xoffset),$get(yoffset),$add($get(w3),10),%topBarH%,$get(t3),$get(t3),SETGLOBAL:MIDRIGHT:MR1;SETGLOBAL:MID:M;SETGLOBAL:RIGHT:R;SETGLOBAL:bTog:0;SETGLOBAL:BOT:B2;SETGLOBAL:LEFT:L9;REFRESH,fontcolor:%colorSchemeLight%,brushcolor:40-40-40-00)


$font(FontAwesome,12,)
$puts(xoffset,$add($get(xoffset),$add($get(w3),10)))
$textbutton($get(xoffset),$get(yoffset),$add($get(w5),10),%topBarH%,$get(t5),$get(t5),SETGLOBAL:MIDRIGHT:MR;SETGLOBAL:MID:M1;SETGLOBAL:RIGHT:R0;SETGLOBAL:bTog:0;SETGLOBAL:BOT:B2;SETGLOBAL:LEFT:L7;REFRESH,fontcolor:%colorSchemeLight%,brushcolor:40-40-40-00)


$puts(yoffset,10)
$font(Digital-7,10,)
$puts(xoffset,$add($get(xoffset),$add($get(w5),10)))
...
$set_ps_global(BW,32)
  ...
  $textbutton($add(%MBX%,$mul(4,%BW%)),%MBY%,%BW%,%BW%,%M4%,%M4%,SETGLOBAL:MIDRIGHT:MR1;SETGLOBAL:MID:M;SETGLOBAL:RIGHT:R;SETGLOBAL:bTog:0;SETGLOBAL:BOT:B2;SETGLOBAL:LEFT:L0;REFRESH,fontcolor:$ifequal($strcmp(%MID%,M3),1,%TBSC%,%TBNC%),fontcolor:%TBSC%)
